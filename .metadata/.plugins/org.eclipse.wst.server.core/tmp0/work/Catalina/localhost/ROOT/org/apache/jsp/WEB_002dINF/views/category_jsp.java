 ...
 * Generated at: 2020-12-13 14:38:50 UTC
...
public final class category_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\taddList += \"<tr class='row' code='\"+this.CATEGORYCODE+\"' name='\"+this.CATEGORYNAME+\"'><td width=100 class='lcategoryname' >\"+this.CATEGORYNAME.split(\"/\")[1]+\"<input type='button' class='btnaddrow' value='+'</td>\";\n");
      ...
      out.write("\t\t\t\t\taddList += \"<tr class='row' code='\"+this.CATEGORYCODE+\"'name='\"+this.CATEGORYNAME+\"'><td width=100 class='mcategorycode'>002</td>\";\n");
      out.write("\t\t\t\t\taddList += \"<td width=100 class='mcategoryname'><input type='text' size=30 class='midname' ></td></tr>\";\n");
      out.write("\t\t\t\t\taddList += \"<tr class='row' code='\"+this.CATEGORYCODE+\"'name='\"+this.CATEGORYNAME+\"'><td width=100 class='mcategorycode'>003</td>\";\n");
      out.write("\t\t\t\t\taddList += \"<td width=100 class='mcategoryname'><input type='text' size=30  class='midname' ></td></tr>\";\n");
      out.write("\t\t\t\t});\n");
