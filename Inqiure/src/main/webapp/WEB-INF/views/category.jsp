	...
	$.ajax({
		...
		success:function(data) {
			if($(data.CATEGORYNAME)!= null){
				...
				$(data).each(function() {
					var rowspan=3;
					addList += "<tr class='row' code='"+this.CATEGORYCODE+"' name='"+this.CATEGORYNAME+"'><td width=100 class='lcategoryname' >"+this.CATEGORYNAME.split("/")[1]+"<input type='button' class='btnaddrow' value='+'</td>";
					...
					addList += "<tr class='row' code='"+this.CATEGORYCODE+"'name='"+this.CATEGORYNAME+"'><td width=100 class='mcategorycode'>002</td>";
					addList += "<td width=100 class='mcategoryname'><input type='text' size=30 class='midname' ></td></tr>";
					addList += "<tr class='row' code='"+this.CATEGORYCODE+"'name='"+this.CATEGORYNAME+"'><td width=100 class='mcategorycode'>003</td>";
					addList += "<td width=100 class='mcategoryname'><input type='text' size=30  class='midname' ></td></tr>";
				});
					addList +="</tbody>";
				$("#tbl1").html(addList);
